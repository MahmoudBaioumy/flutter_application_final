...
class new_coll_men extends StatefulWidget {
  const new_coll_men({super.key});

  @override
  State<new_coll_men> createState() => _new_coll_menState();
}

class _new_coll_menState extends State<new_coll_men> {
  @override
