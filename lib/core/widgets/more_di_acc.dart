...
class more_ditel_acc extends StatefulWidget {
  ...
  @override
  State<more_ditel_acc> createState() => _more_ditel_accState();
}

class _more_ditel_accState extends State<more_ditel_acc> {
  @override
  int Colorindex = 0;
